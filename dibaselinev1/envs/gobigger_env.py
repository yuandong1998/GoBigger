...
class GoBiggerEnv(BaseEnv):
    ...
    def __init__(self, cfg: dict) -> None:
        ...
        self._init_flag = False #这个是什么意思
        self._speed = cfg.speed
        self._all_vision = cfg.all_vision #这个什么意思
    ...
    def _obs_transform(self, obs: tuple) -> list:
        ...
        #total time和last time离散化，是不是不应该离散化，归一化就好了
        ...
        # player
        player_state = OrderedDict(player_state) #为什么要order
        obs = []
